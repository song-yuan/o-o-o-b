...
<div class="modal-body">
    <div class="ibox-content">
        <form class="form-horizontal" method="POST" action="<?php echo url('admin/create');?>">
            <input type="hidden" name="_token" value="<?php echo csrf_token();?>"/>
            <div class="form-group <?php if($errors->first('user_name')) echo 'has-error';?>">
                <label class="col-lg-2 control-label">姓名</label>
                <div class="col-lg-10">
                    <input type="text" id="admin_name" name="admin[user_name]" placeholder="姓名" value="<?php echo old('user_name');?>" class="form-control"> 
            ...
            <div class="form-group <?php if($errors->first('email')) echo 'has-error';?>">
                ...
                <div class="col-lg-10">
                    <input type="text" id="admin_name" name="admin[email]" placeholder="邮箱" value="<?php echo old('email');?>" class="form-control"> 
            ...
            <div class="form-group <?php if($errors->first('mobile')) echo 'has-error';?>">
                ...
                <div class="col-lg-10">
                    <input type="text" id="admin_display_name" name="admin[mobile]" placeholder="手机" value="<?php echo old('mobile');?>" class="form-control"> 
            ...
            <div class="form-group <?php if($errors->first('password')) echo 'has-error';?>">
                ...
                <div class="col-lg-10">
                    <input type="text" id="admin_description" name="admin[password]" placeholder="密码" value="<?php echo old('password');?>" class="form-control"> 
