...
<div class="modal-body">
    <div class="ibox-content">
        <form class="form-horizontal" method="POST" action="<?php echo url('permission/create');?>">
            <input type="hidden" name="_token" value="<?php echo csrf_token();?>"/>
            <div class="form-group <?php if($errors->first('name')) echo 'has-error';?>">
                <label class="col-lg-2 control-label">权限</label>
                <div class="col-lg-10">
                    <input type="text" id="permission_name" name="permission[name]" placeholder="权限" value="<?php echo old('name');?>" class="form-control"> 
            ...
            <div class="form-group <?php if($errors->first('display_name')) echo 'has-error';?>">
                ...
                <div class="col-lg-10">
                    <input type="text" id="permission_display_name" name="permission[display_name]" placeholder="名称" value="<?php echo old('display_name');?>" class="form-control"> 
            ...
            <div class="form-group <?php if($errors->first('description')) echo 'has-error';?>">
                ...
                <div class="col-lg-10">
                    <input type="text" id="permission_description" name="permission[description]" placeholder="描述" value="<?php echo old('description');?>" class="form-control"> 
