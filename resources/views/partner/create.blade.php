        ...
        <div class="ibox-content">
            <form class="form-horizontal" method="POST">
                ...
                <div class="form-group <?php if($errors->first('partner_name')) echo 'has-error';?>">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="partner[partner_name]" placeholder="公司名称" class="form-control"> 
                ...
                <div class="form-group <?php if($errors->first('home_page')) echo 'has-error';?>">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="partner[home_page]" placeholder="公司主页" class="form-control"> 
                ...
                <div class="form-group <?php if($errors->first('api_url')) echo 'has-error';?>">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="partner[api_url]" placeholder="API网址" class="form-control"> 
